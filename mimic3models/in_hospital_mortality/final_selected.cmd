...
python main_CBCE.py --network lstm  --dim 16 --timestep 1.0 --depth 2 --dropout 0.3 --mode train --cuda --epochs 100 --coef_contra_loss 0  --batch_size 256 --weight_decay 0 2>&1 | tee log_CBCE/final_CBCE+SCL_bach_cmd_a0.bs256.weightDecay0.log
python main_CBCE.py --network lstm  --dim 16 --timestep 1.0 --depth 2 --dropout 0.3 --mode train --cuda --epochs 100 --coef_contra_loss 0.0025  --batch_size 256 --weight_decay 0 2>&1 | tee log_CBCE/final_CBCE+SCL_bach_cmd_a0.0025.bs256.weightDecay0.log
